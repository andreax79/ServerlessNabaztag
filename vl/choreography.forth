...
http-get drop json-parse
dup "weather" json-get 1 set-info-animation \ weather
dup "stock" json-get 2 set-info-animation \ stock
dup "traffic" json-get 3 set-info-animation \ traffic
dup "service4" json-get 4 set-info-animation \ generic 4
dup "service5" json-get 5 set-info-animation \ generic 5
dup "mail" json-get 6 set-info-animation \ mail
    "pollution" json-get 7 set-info-animation \ pollution
